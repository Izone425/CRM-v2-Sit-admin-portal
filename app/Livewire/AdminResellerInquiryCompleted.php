...
class AdminResellerInquiryCompleted extends Component implements HasTable, HasForms
{
    ...
    {
        return $table
            ->query(ResellerInquiry::query()->where('status', 'completed'))
            ->columns([
    ...
    {
        return view('livewire.admin-reseller-inquiry-completed');
    }
}
