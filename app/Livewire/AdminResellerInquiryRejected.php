...
class AdminResellerInquiryRejected extends Component implements HasTable, HasForms
{
    ...
    {
        return $table
            ->query(ResellerInquiry::query()->where('status', 'rejected'))
            ->columns([
    ...
    {
        return view('livewire.admin-reseller-inquiry-rejected');
    }
}
