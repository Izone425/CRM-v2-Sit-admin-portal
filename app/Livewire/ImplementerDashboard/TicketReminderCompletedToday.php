...
class TicketReminderCompletedToday extends Component implements HasForms, HasTable
{
            ...
            ->actions([
                ...
                Action::make('fail')
                    ...
                    ->action(function ($record) {
                        ...
                        $oldIsPassed = $record->isPassed === null ? 'Pending' : ($record->isPassed ? 'Passed' : 'Failed');
                        ...
                        TicketLog::create([
                            'ticket_id' => $record->id,
                            'old_value' => $oldIsPassed,
                            'new_value' => 'Failed',
                            'action' => "Marked ticket {$record->ticket_id} as Failed and reopened.",
                            'field_name' => 'isPassed',
                            'change_reason' => 'Ticket marked as failed via Ticket Reminder; status set to Reopen',
                            'old_eta' => null,
                            'new_eta' => null,
                            'updated_by' => $userId,
                            'user_name' => $ticketSystemUser?->name ?? 'HRcrm User',
    ...
    {
        return view('livewire.implementer_dashboard.ticket-reminder-completed-today');
    }
}
