...
class HrChecklistActiveBigCompTable extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.leadowner_dashboard.hr-checklist-active-big-comp-table');
    }
}
