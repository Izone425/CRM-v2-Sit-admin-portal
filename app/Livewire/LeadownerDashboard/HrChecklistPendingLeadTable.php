...
class HrChecklistPendingLeadTable extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.leadowner_dashboard.hr-checklist-pending-lead-table');
    }
}
