...
class HrChecklistCallAttemptSmallCompTable extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.leadowner_dashboard.hr-checklist-call-attempt-small-comp-table');
    }
}
