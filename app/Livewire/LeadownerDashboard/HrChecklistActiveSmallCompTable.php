...
class HrChecklistActiveSmallCompTable extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.leadowner_dashboard.hr-checklist-active-small-comp-table');
    }
}
