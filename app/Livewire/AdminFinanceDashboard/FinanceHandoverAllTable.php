...
class FinanceHandoverAllTable extends Component implements HasForms, HasTable
{
    ...
    public function getFinanceHandovers()
    {
    ...
    public function table(Table $table): Table
    {
        return $table
            ->poll('300s')
            ->query($this->getFinanceHandovers())
    ...
    {
        return view('livewire.admin-finance-dashboard.finance-handover-all-table');
    }
}
