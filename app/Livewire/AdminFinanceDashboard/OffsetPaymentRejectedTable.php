...
class OffsetPaymentRejectedTable extends Component implements HasTable, HasForms
{
    ...
    {
        return $table
            ->query(OffsetPaymentHandover::where('status', 'rejected'))
    ...
    {
        return view('livewire.admin-finance-dashboard.offset-payment-rejected-table');
    }
}
