    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                //                 $financeInvoice = $record->financeInvoice()->first();
                //                 if ($financeInvoice) {
                ...
                //             } catch (\Exception $e) {
                //                 Log::error("Error marking task as completed for handover {$record->id}: " . $e->getMessage());
            ...
            //         ->modalDescription('Are you sure you want to cancel all selected tasks? This action cannot be undone.')
            //         ->action(function (Collection $records): void {
            //             $cancelledCount = 0;
            //             $skippedCount = 0;
