...
class ResellerRenewalRequestFd extends Component
{
    ...
    public function submitRequest()
    {
        ...
        $this->dispatch('notify', message: 'FD request submitted successfully!', type: 'success');
        $this->closeModal();
    }

    public function render()
    {
        return view('livewire.reseller-renewal-request-fd', [
