...
class ArFollowUpOverdueUsdV2NonReseller extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.admin_renewal_dashboard.ar-follow-up-overdue-usd-v2-non-reseller');
    }
