...
class ArFollowUpOverdueMyrNonReseller extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.admin_renewal_dashboard.ar-follow-up-overdue-myr-non-reseller');
    }
