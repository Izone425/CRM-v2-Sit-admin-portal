...
class ArFollowUpUpcomingMyrV2NonReseller extends Component implements HasForms, HasTable
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                ->button()
                ->color('info') // Blue color for MYR non-reseller (changed from warning to info)
                ->label('Actions')
            ]);
    }
    ...
    {
        return view('livewire.admin_renewal_dashboard.ar-follow-up-upcoming-myr-v2-non-reseller');
    }
