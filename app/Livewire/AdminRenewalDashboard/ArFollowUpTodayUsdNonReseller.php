...
class ArFollowUpTodayUsdNonReseller extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.admin_renewal_dashboard.ar-follow-up-today-usd-non-reseller');
    }
