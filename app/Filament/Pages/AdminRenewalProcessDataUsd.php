    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(function () {
                ...
                // Exclude companies that already have any relevant USD license expiring beyond current year
                ...
                $preRenewedQuery = RenewalDataUsd::query()
                    ->where('f_currency', 'USD')
                    ->where('f_expiry_date', '>', $endOfCurrentYear);
                RenewalDataUsd::applyProductExclusions($preRenewedQuery);
            ...
            ->bulkActions([
                \Filament\Tables\Actions\BulkActionGroup::make([
                    \Filament\Tables\Actions\BulkAction::make('batch_complete_renewal')
                        ->label('Batch Update Complete Renewal')
                        ->icon('heroicon-o-check-circle')
                        ->color('success')
                        ->requiresConfirmation()
                    ...
                    \Filament\Tables\Actions\BulkAction::make('batch_completed_reseller_portal')
                        ->label('Batch Update Completed(Reseller Portal)')
                    ...
                    \Filament\Tables\Actions\BulkAction::make('batch_assign_admin')
                        ->label('Batch Update Assign Admin Renewal')
                    ...
                    \Filament\Tables\Actions\BulkAction::make('batch_assign_to_me')
                        ->label('Batch Update Assign to Me')
                        ->icon('heroicon-o-user')
                        ->color('success')
                        ->requiresConfirmation()
