                    ...
                    <tr>
                        ...
                        <td>
                            @if($handover->timetec_proforma_invoice && $handover->invoice_url)
                                <a href="{{ $handover->invoice_url }}" target="_blank" style="color: #667eea; font-weight: 600; text-decoration: none;">
                                    {{ $handover->timetec_proforma_invoice }}
                                    <i class="fas fa-external-link-alt" style="font-size: 0.7rem;"></i>
                                </a>
                            @elseif($handover->timetec_proforma_invoice)
                                <span style="font-weight: 600;">{{ $handover->timetec_proforma_invoice }}</span>
                            @else
                        ...
                        <td class="date-cell">
                            {{ $handover->completed_at ? $handover->completed_at->format('d M Y, H:i') : '-' }}
                        </td>
                        <td>
                            @if($handover->offset_payment_at)
                                <span style="font-size: 0.75rem; color: #10b981; font-weight: 600;">
                                    ✓ Offset on {{ $handover->offset_payment_at->format('d M Y, h:i A') }}
                                </span>
                            @else
                                <button wire:click="confirmOffsetPayment({{ $handover->id }})" class="pdf-button" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
