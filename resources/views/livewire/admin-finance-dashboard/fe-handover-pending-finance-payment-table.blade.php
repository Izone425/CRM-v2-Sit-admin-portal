<div class="p-4 bg-white rounded-lg shadow-lg" style="height: auto;" x-data="{ showRefresh: false }" @mouseenter="showRefresh = true" @mouseleave="showRefresh = false">
    <style>
        .fi-ta-row.success { background-color: #d4edda !important; }
        .fi-ta-row.success:hover { background-color: #c3e6cb !important; }
    </style>

    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-2">
            <h3 class="text-lg font-bold" style="color: red;">Bill as End User - Pending Finance Payment</h3>
            <div class="relative">
                <button
