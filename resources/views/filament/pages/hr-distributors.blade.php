<x-filament-panels::page>
    <div class="space-y-4">
        ...
        @if ($activeTab === 'all')
            @livewire('hr-admin-dashboard.hr-license-table', ['category' => 'Distributor'], key('hr-license-distributor'))
        @else
            @livewire('hr-admin-dashboard.partner-applications-table', ['type' => 'distributor'], key('pending-distributor'))
        @endif
    </div>
</x-filament-panels::page>
